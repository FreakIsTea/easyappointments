...
/* ----------------------------------------------------------------------------
 * Foppen Visitors - Patch Utility Script
 *
 ...
 * @support     Foppen Visitors v1.x.x
 * ---------------------------------------------------------------------------- */
...
function detect_local_version()
{
    ...
    if (!file_exists($config_file_path)) {
        die(
            'Failed to detect the local Foppen Visitors version, please move the patch.php script in the root directory of your Foppen Visitors installation.'
        );
    }
...
echo LINE_BREAK . '➜ Foppen Visitors - Patch Utility Script' . LINE_BREAK . LINE_BREAK;
