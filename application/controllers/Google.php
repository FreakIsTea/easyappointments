...
class Google extends EA_Controller
{
    ...
    /**
     * Complete synchronization of appointments between Google Calendar and Foppen Visitors.
     *
    ...
    public static function sync(string $provider_id = null): void
    {
        try {
            ...
            foreach ($local_events as $local_event) {
                ...
                try {
                    ...
                    if ($google_event->getStatus() == 'cancelled') {
                        throw new Exception('Event is cancelled, remove the record from Foppen Visitors.');
                    }

                    // If Google Calendar event is different from Foppen Visitors appointment then update Foppen Visitors record.
                    ...
                    // Appointment not found on Google Calendar, delete from Foppen Visitors.
            ...
            // Add Google Calendar events that do not exist in Foppen Visitors.
            ...
            foreach ($google_events->getItems() as $google_event) {
                ...
                // Record doesn't exist in the Foppen Visitors, so add the event now.
                $local_event = [
     ...
     * documentation of OAuth), every Foppen Visitors installation should use its own calendar api key. So in every
     * api console account, the "http://path-to-Foppen Visitors/google/oauth_callback" should be included in an
