...
<head>
    ...
    <title>Installation | Foppen Visitors</title>
...
<header>
    <div class="container">
        <h1 class="page-title">Foppen Visitors Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the Foppen Visitors installation page.</h3>
        <p>
            This page will help you set the main settings of your Foppen Visitors installation. You will be able to
            ...
            If you face any problems during the usage of Foppen Visitors you can always check the
    ...
    <div class="mb-2">
        <h3>License</h3>
        Foppen Visitors is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
        of Foppen Visitors in any way <br> you agree with the terms described in the following url:
