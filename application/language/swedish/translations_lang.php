...
$lang['about_app_info'] = 'Foppen Visitors är ett system som gör det möjligt för dina kunder att, via internet, boka tid för tjänster hos er. Bokningarna kan synkroniseras med dina leverantörers Google-kalendrar så att de bli tillgängliga även för andra tjänster.';
$lang['current_version'] = 'Nuvarande version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Om du stöter på problem när du använder Foppen Visitors kan du söka i den officiella Google-gruppen för support. Du kan även underlätta för utvecklarna genom att registrera ett ärende på GitHub-sidan.';
...
$lang['license'] = 'Licens';
$lang['about_app_license'] = 'Foppen Visitors använder GPLv3 licensen. Genom att använda koden till Foppen Visitors på något sätt accepterar du villkoren i följande url.';
...
$lang['ea_update_success'] = 'Foppen Visitors är uppdaterad.';
...
$lang['api_token_hint'] = 'Ställ in en hemlig token för att aktivera tokenbaserad autentisering av Foppen Visitors API.';
