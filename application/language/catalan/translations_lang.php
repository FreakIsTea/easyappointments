...
$lang['about_app'] = 'Quant a Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors és una aplicació web molt ajustable que permet als vostres clients reservar cites amb vosaltres a través del web. A més, us permet sincronitzar amb Google Calendar de manera que ho podeu usar amb altres serveis.';
$lang['current_version'] = 'Versió actual';
$lang['support'] = 'Suport';
$lang['about_app_support'] = 'Si trobeu qualsevol problema fent servir Foppen Visitors, podeu consultar el Google Group per a trobar respostes. També podeu crear noves incidències a la pàgina de Google Code per ajudar al desenvolupament.';
...
$lang['about_app_license'] = 'Foppen Visitors es distribueix amb una llicència GPLv3. Usant el codi d\'Foppen Visitors de qualsevol manera, esteu consentint els termes descrits en la següent URL:';
...
$lang['ea_update_success'] = 'Foppen Visitors s\'ha actualitzat correctament.';
...
$lang['api_token_hint'] = 'Establiu un token secret per permetre l\'autenticació basada en tokens de l\'API d\'Foppen Visitors.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API us permet interaccionar amb totes les dades Foppen Visitors via el protocol HTTP i els API endpoint disponibles i crear les vostres pròpies integracions.';
