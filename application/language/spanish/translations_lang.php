...
$lang['about_app'] = 'Acerca de Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors es un aplicativo web completamente personalizable que le permitirá a sus clientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
$lang['current_version'] = 'Versión actual';
$lang['support'] = 'Soporte';
$lang['about_app_support'] = 'El grupo oficial de respuestas de Google Groups se encuentra a su disposición, en caso de que encuentre algún inconveniente con Foppen Visitors.  También podrá informar incidentes en la página de Google Code y así ayudar en el proceso de desarrollo de la herramienta.';
...
$lang['about_app_license'] = 'Foppen Visitors se encuentra bajo licencia GPLv3. Todo tipo de uso del código de Foppen Visitors presume la aceptación de los términos desciptos en la siguiente dirección web:';
...
$lang['ea_update_success'] = 'Foppen Visitors ha sido actualizado exitosamente';
...
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API de Foppen Visitors.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the Foppen Visitors data via the HTTP protocol and the available API endpoints and create your own integrations.';
