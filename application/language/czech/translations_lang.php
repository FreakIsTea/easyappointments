...
$lang['about_app'] = 'O aplikaci Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors je vysoce přizpůsobitelná webová aplikace, která vašim zákazníkům umožňuje rezervovat si s vámi schůzky prostřednictvím webu. Navíc poskytuje možnost synchronizovat vaše data s Kalendářem Google, takže je můžete využívat v rámci dalších služeb.';
$lang['current_version'] = 'Aktuální verze';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Pokud při používání Foppen Visitors narazíte na jakékoli problémy, můžete odpovědi hledat v oficiální skupině Google. Také můžete založit nový incident na stránce Google Code za účelem podpory dalšího vývoje.';
...
$lang['about_app_license'] = 'Foppen Visitors je licencováno pod licencí GPLv3. Používáním kódu Foppen Visitors v jakékoli formě souhlasíte s podmínkami popsanými v dokumentu na následující adrese:';
...
$lang['ea_update_success'] = 'Aplikace Foppen Visitors byla úspěšně aktualizována.';
...
$lang['api_token_hint'] = 'Nastavte bezpečnostní token, abyste povolili autentizaci tokenem v API Foppen Visitors.';
