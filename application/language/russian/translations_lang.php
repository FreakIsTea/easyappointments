...
$lang['about_app'] = 'О приложении Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors хорошо настраиваемое веб приложение которое позволяет вашим заказчикам оформлять время предоставления услуг через интернет. Кроме того, имеется возможность синхронизации с вашими Google-календарями так что вы сможете использовать план заказанных мероприятий.';
$lang['current_version'] = 'Текущая версия';
$lang['support'] = 'Поддержка';
$lang['about_app_support'] = 'Если произошли проблемы с использованием Foppen Visitors вы можете использовать официальную Google группу для поиска ответа. Вы можете также создать новый запрос на странице проекта в Google Code вопрос на странице Google Code для того, чтобы помочь проекту развиватся.';
...
$lang['about_app_license'] = 'Foppen Visitors обладает лицензией GPLv3. При использовании кода приложения в любом случае вы соглашаетесь с условиями, описанными в следующей URL:';
...
$lang['api_token_hint'] = 'Установите секретный токен, чтобы включить аутентификацию на основе токена в Foppen Visitors API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API позволяют вам взаимодействовать со всеми данными Foppen Visitors через протокол HTTP и доступные конечные точки API и создавать собственные интеграции.';
