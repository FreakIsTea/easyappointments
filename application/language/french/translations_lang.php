...
$lang['about_app'] = 'Au sujet d\'Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors est une application Web hautement personnalisable qui permet à vos clients de prendre rendez-vous avec vous via le web. En outre, elle offre la possibilité de synchroniser vos données avec un calendrier Google afin que vous puissiez les utiliser avec d\'autres services. Foppen Visitors est un projet open source et vous pouvez le télécharger et l\'installer même pour un usage commercial. Foppen Visitors fonctionnera sans problème avec votre site web existant car il peut être installé dans un dossier spécifique du serveur et bien sûr, les deux sites peuvent partager la même base de données.';
...
$lang['about_app_license'] = 'Foppen Visitors est fourni sous licence GPLv3. En utilisant le code d\'Foppen Visitors, quelqu\'en soit l\'usage, vous êtes tenu d\'accepter les termes décrits dans l\'URL suivante :';
...
$lang['ea_update_success'] = 'Foppen Visitors à été mis à jour avec succès.';
...
$lang['api_token_hint'] = 'Définissez un jeton secret afin d\'activer l\'authentification basée sur le jeton de l\'API Foppen Visitors. ';
...
$lang['api'] = 'API';
$lang['api_info'] = 'L\'API vous permet d\'interagir avec toutes les données de Foppen Visitors via le protocole HTTP et les points de terminaison API disponibles et créer vos propres intégrations.';
