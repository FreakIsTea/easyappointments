...
$lang['about_app_info'] = 'Foppen Visitors je veoma prilagodljiva veb-aplikacija koja omogućava Vašim korisnicima da zakazuju termine, a Vama da njima upravljate. Uz to, omogućava istovremenu povezanost Vaših podataka sa Google kalendarom koje možete onda koristiti na ostalim servisima.';
$lang['current_version'] = 'Trenutna verzija';
$lang['support'] = 'Podrška';
$lang['about_app_support'] = 'Ako imate bilo kakvih problema u radu sa aplikacijom Foppen Visitors, odgovore možete potražiti na službenoj stranici Google Group. Možete osmisliti i novu verziju aplikacije na Google Code stranici u svrhu razvoja aplikacije.';
...
$lang['about_app_license'] = 'Foppen Visitors aplikacija je licencirana pod GPLv3 licencom. Koristeći Foppen Visitors na bilo koji način, slažete se sa uslovima korištenja koji su dati na sledećoj adresi:';
...
$lang['ea_update_success'] = 'Foppen Visitors je uspešno ažuriran!';
...
$lang['api_token_hint'] = 'Postavite tajni token kako biste omogućili pristup Foppen Visitors API.';
