...
$lang['about_app'] = 'O Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors je visoko prilagodljiva web aplikacija koja omogućuje vašim klijentima da rezerviraju sastanke s vama putem weba. Osim toga, omogućuje sinkronizaciju vaših podataka s Google kalendarom, tako da ih možete koristiti s drugim uslugama.';
$lang['current_version'] = 'Trenutačna verzija';
$lang['support'] = 'Podrška';
$lang['about_app_support'] = 'Ako naiđete na probleme prilikom korištenja Foppen Visitors, možete pretraživati službenu Google grupu za odgovore. Možda ćete također trebati stvoriti novi problem na stranici Google Code kako biste pomogli napretku razvoja.';
...
$lang['about_app_license'] = 'Foppen Visitors je licenciran pod GPLv3 licencom. Korištenjem koda Foppen Visitors na bilo koji način pristajete na uvjete opisane na sljedećem URL-u:';
...
$lang['ea_update_success'] = 'Foppen Visitors je uspješno ažuriran.';
...
$lang['api_token_hint'] = 'Postavite tajni token kako biste omogućili autentifikaciju temeljenu na tokenima za Foppen Visitors API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API vam omogućuje interakciju sa svim podacima Foppen Visitors putem HTTP protokola i dostupnih krajnjih točaka API-ja te stvaranje vlastitih integracija.';
