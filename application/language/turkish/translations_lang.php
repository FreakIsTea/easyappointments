...
$lang['about_app'] = 'Foppen Visitors Hakkında';
...
$lang['about_app_info'] = 'Foppen Visitors yüksek ölçüde özelleştirilebilen, müşterilerinizin web üzerinden randevu almasını sağlayan bir uygulamadır. Ayrıca, bilgilerinizi Google Takvim ile eşitleyerek diğer uygulamalarla da entegre olmasını sağlar. ';
$lang['current_version'] = 'Mevcut Versiyon';
$lang['support'] = 'Destek';
$lang['about_app_support'] = 'Foppen Visitors kullanımı sırasında sorun yaşamanız halinde resmi Google Group üzerinde arama yapabilirsiniz. Ayrıca geliştirmeye destek olmak için Google Code sayfasında yeni sorun girişi de yapabilirsiniz.';
...
$lang['license'] = 'Lisans';
$lang['about_app_license'] = 'Foppen Visitors GPLv3 kapsamında lisanslıdır. Bu yazılımı herhangi bir biçimde kullanarak aşağıdaki adreste belirtilen koşulları kabul etmiş olursunuz:';
...
$lang['ea_update_success'] = 'Foppen Visitors başarı ile güncellendi.';
...
$lang['api_token_hint'] = 'Foppen Visitors Api sinin belirteç tabanlı kimlik doğrulamasını etkinleştirmek için gizli bir belirteç ayarlayın.';
