...
$lang['about_app'] = 'Info su Foppen Visitors';
...
$lang['about_app_info'] = 'Foppen Visitors è un\'applicazione web estremamente personalizzabile che permette ai tuoi clienti di prenotare appuntamenti con te attraverso il web. Inoltre, fornisce la possibilità di sincronizzare i tuoi dati con Google Calendar in modo da poterli usare in altri servizi.';
$lang['current_version'] = 'Versione corrente';
$lang['support'] = 'Supporto';
$lang['about_app_support'] = 'Se incontri un problema quando utilizzi Foppen Visitors puoi cercare sul Gruppo Google ufficiale per le risposte. Potresti anche aver bisogno di creare una nuova segnalazione sulla pagina Google Code al fine di aiutarci negli sviluppi futuri.';
...
$lang['about_app_license'] = 'Foppen Visitors è distributo sotto licenza GPLv3. Usando il codice di Foppen Visitors stai accettando i termini e le condizioni descritte al seguente URL:';
...
$lang['ea_update_success'] = 'Foppen Visitors è stato aggiornato con successo.';
...
$lang['api_token_hint'] = 'Imposta un token segreto per abilitare l\'autenticazione basata su token nelle API di Foppen Visitors.';
