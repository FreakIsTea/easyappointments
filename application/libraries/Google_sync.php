...
class Google_sync
{
    ...
    public function initialize_clients(): void
    {
        ...
        $this->client->setApplicationName('Foppen Visitors');
     ...
     * where the user grants access to his data for the Foppen Visitors app.
     */
     ...
     * provider granted consent to Foppen Visitors for use his Google Calendar account.
     *
     ...
     *
     * This method checks whether the appointment's provider has enabled the Google Sync utility of Foppen Visitors
