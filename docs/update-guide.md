...
This page will guide you through the update procedure of your Foppen Visitors installation. You will need to follow the steps below in order to have successful results.
...
###### Step 1: Update your Foppen Visitors files 
...
Open your browser to the Foppen Visitors installation URL, login to the backend and type in the browser address the following URL to complete the database upgrade: `https://url/to/easyappointments/folder/index.php/backend/update`
